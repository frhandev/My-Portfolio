    ...
    <section id="Portfolio" className="portfolio">
      ...
      <div className="cards">
        ...
        <ProjectCard
          ...
          img={p3}
          desc={
            "A fictional product landing page for a RTX 3060 designed using HTML & CSS."
          }
        />
        <ProjectCard
          ...
          img={p2}
          desc={
            "A landing page for a fictional fitness gym designed using HTML, CSS, JavaScript, and React."
          }
        />
        ...
        <ProjectCard
          ...
          img={p4}
          desc={
            "A movie website created for tutorial using HTML, CSS, Javascript, React.js"
          }
        />
      </div>
    </section>
